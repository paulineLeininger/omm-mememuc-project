...
const Meme = ({
    ...
    return (
        <div ref={exportRef} style={{ position:"relative", objectFit: "contain", display: 'flex', justifyContent: 'center' }}>
                        <img ref = {imageRef}
